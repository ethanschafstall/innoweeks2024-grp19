...
@dso_cache = dso_local local_unnamed_addr global [870 x %struct.DSOCacheEntry] [
	...
	%struct.DSOCacheEntry {
		i64 421488747, ; hash 0x191f686b, from name: FeelingsApp.dll.so
		i8 0, ; bool ignore
	...
	%struct.DSOCacheEntry {
		i64 734693584, ; hash 0x2bca88d0, from name: FeelingsApp
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-FeelingsApp.dll.so
		ptr null; void* handle (0x0)
	}, ; 135
	...
	%struct.DSOCacheEntry {
		i64 885522051, ; hash 0x34c7fe83, from name: aot-FeelingsApp
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-FeelingsApp.dll.so
		ptr null; void* handle (0x0)
	}, ; 176
	%struct.DSOCacheEntry {
		i64 887134931, ; hash 0x34e09ad3, from name: libaot-FeelingsApp
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-FeelingsApp.dll.so
		ptr null; void* handle (0x0)
	}, ; 177
	...
	%struct.DSOCacheEntry {
		i64 2451128252, ; hash 0x92193fbc, from name: libaot-FeelingsApp.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-FeelingsApp.dll.so
		ptr null; void* handle (0x0)
	}, ; 492
	...
	%struct.DSOCacheEntry {
		i64 3974461185, ; hash 0xece57701, from name: aot-FeelingsApp.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-FeelingsApp.dll.so
		ptr null; void* handle (0x0)
	}, ; 811
